...
LDFLAGS := -ldflags "-X github.com/dbchaincloud/iavl.Version=$(VERSION) -X github.com/dbchaincloud/iavl.Commit=$(COMMIT) -X github.com/dbchaincloud/iavl.Branch=$(BRANCH)"
